...
#=============================================================================
set project_name  udp_dual_phy1g
...
# Wrapper
import_files -norecurse wrapper_1g.v

# Copy .dat files for ROM init
set src_dir [file dirname [lindex [glob vivado_prj/udp_dual_phy1g.srcs/sources_1/imports/verilog/*.v] 0]]
