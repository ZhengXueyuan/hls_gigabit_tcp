@echo off
REM wrapper_min with registered generator outputs
...
call C:\AMDDesignTools\2025.2\Vivado\bin\vivado.bat -mode batch -source run_vivado_minreg.tcl -log vivado_minreg.log -nojournal
