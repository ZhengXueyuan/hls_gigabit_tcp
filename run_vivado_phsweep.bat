@echo off
REM wrapper_min with auto phase sweep
...
call C:\AMDDesignTools\2025.2\Vivado\bin\vivado.bat -mode batch -source run_vivado_phsweep.tcl -log vivado_phsweep.log -nojournal
