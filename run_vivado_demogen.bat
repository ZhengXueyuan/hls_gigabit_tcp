@echo off
REM demo rebuild + demo_clone generator (TX source structure test)
...
call C:\AMDDesignTools\2025.2\Vivado\bin\vivado.bat -mode batch -source run_vivado_demogen.tcl -log vivado_demogen.log -nojournal
