@echo off
REM k720 demo rebuild in 2025.2 (toolchain isolation test)
...
call C:\AMDDesignTools\2025.2\Vivado\bin\vivado.bat -mode batch -source run_vivado_demorebuild.tcl -log vivado_demorebuild.log -nojournal
