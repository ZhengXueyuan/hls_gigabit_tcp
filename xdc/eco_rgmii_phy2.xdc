...
# --- Clocks ---
# phy1_rxc: RGMII RX clock from RTL8211E. Link forced to 100M via MDIO (board
# verified) → 25MHz/40ns. Feeds the MMCME2_ADV that generates gmii_clk; the
# period MUST match reality or bitgen DRC (PDRC-34) flags a fake 3GHz VCO.
...
set_property PACKAGE_PIN W1  [get_ports phy1_mdio]
