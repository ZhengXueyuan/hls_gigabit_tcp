...
set src_dir [file dirname [lindex [glob vivado_prj/udp_dual_eco.srcs/sources_1/imports/verilog/*.v] 0]]
...
add_files -fileset constrs_1 xdc/eco_rgmii.xdc
